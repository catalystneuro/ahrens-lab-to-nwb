...
class YuMu2019SingleColorSegmentationInterface(BaseSegmentationExtractorInterface):
    ...
    def run_conversion(
        ...
        plane_segmentation = image_segmentation.create_plane_segmentation(
            name=metadata["Ophys"]["ImageSegmentation"]["plane_segmentations"],
            description=metadata["Ophys"]["ImageSegmentation"]["plane_segmentations"],
        ...
        for roi in segmentation_extractor.get_roi_ids():
            voxel_mask = segmentation_extractor.get_roi_pixel_masks()
        ...
        timestamps = segmentation_extractor.frame_to_time(np.arange(frames=segmentation_extractor.get_num_frames()))
