...
from ..extractors.yu_mu_cell_2019_downsampled_imaging_extractor import AhrensDownsampledImagingExtractor


class AhrensDownsampledImagingInterface(BaseImagingExtractorInterface):
    """Data Interface for AhrensHdf5ImagingExtractor."""

    Extractor = AhrensDownsampledImagingExtractor
    ...
    def __init__(
        ...
        frame_files = natsorted([file for file in Path(folder_path).iterdir() if ".tif" in file.suffixes])
        imaging_extractors = [
            AhrensDownsampledImagingExtractor(
